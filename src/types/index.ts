...
export const DEFAULT_CATEGORIES: TaskCategory[] = [
  ...
  { name: 'Fitness', color: 'bg-orange-500', icon: '🏃‍♂️' },
...
// Event status types for better type safety
...
// Enhanced AI-related types for advanced task suggestions
export interface AITaskSuggestion {
  title: string;
  category: string;
  priority: 'low' | 'medium' | 'high';
...
// Default categories with proper icons (fixing emoji rendering)
export const DEFAULT_CATEGORIES: TaskCategory[] = [
  { name: 'Work', color: 'bg-blue-500', icon: '💼' },
  { name: 'Personal', color: 'bg-green-500', icon: '🏠' },
  { name: 'Shopping', color: 'bg-yellow-500', icon: '🛒' },
